...
STAGE="0079"
LABEL="MixtarRVS RT Candidate 0079 bounded local health supervisor"
...
TARGET_DIR="$SYSTEM_ROOT/Generations/0032-rootfs-image-bounded-local-health-supervisor"
TARGET="$TARGET_DIR/rootfs.squashfs"
WORK="/tmp/mixtar-stage-0079"
ESP="/tmp/mixtar-esp-0079"
...
safe_rm_work() {
  case "$1" in
    /tmp/mixtar-stage-0079|/tmp/mixtar-stage-0079/*) rm -rf "$1" ;;
...
write_stage_init() {
  ...
  cat > "$root/System/Base/Closure/0079-bounded-local-health.manifest" <<'MANIFEST'
stage=0079
identity=MixtarRVS
...
LOG="$LOG_DIR/0079-bounded-local-health.log"
...
echo "TARGET=$TARGET"
echo "LOG_AFTER_BOOT=/System/Runtime/initramfs/base/System/Base/Closure/0079-bounded-local-health.log"
