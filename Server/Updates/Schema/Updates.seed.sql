...
INSERT INTO trust_anchor(id, owner, kind, fingerprint, material_uri, material_sha256, enabled) VALUES
    ...
    ('mixtarrvs-release', 'MixtarRVS Project', 'openpgp',
     ...
     'https://raw.githubusercontent.com/MixtarRVS/Source/main/Server/Updates/Trust/MixtarRVS-release-key.asc',
...
INSERT OR REPLACE INTO setting(key, value) VALUES
    ...
    ('kernel.version.policy', 'pinned-exact'),
    ('kernel.version.pinned', '7.1.1'),
    ('kernel.rt.version.pinned', '7.1.1-rt2'),
