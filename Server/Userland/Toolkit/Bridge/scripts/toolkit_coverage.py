...
REPORT = Path("Server/Userland/Generated/reports/toolkit-certified-coverage.md")
MANIFEST = Path("Server/Userland/Manifests/selected-tools.json")
COMMAND_COVERAGE = Path("Server/Userland/Generated/reports/command-coverage.md")
REPORTS_DIR = Path("Server/Userland/Generated/reports")
CERT_DIR = Path("Server/Userland/Generated/certification")
TARGET_DIR = Path("Server/Userland/Generated/targets/linux-x64/bin")
